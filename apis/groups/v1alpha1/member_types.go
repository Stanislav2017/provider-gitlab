...
// A MemberParameters defines the desired state of a Gitlab GroupMember.
...
// A MemberSpec defines the desired state of a Gitlab GroupMember.
type MemberSpec struct {
	xpv1.ResourceSpec `json:",inline"`
	ForProvider       MemberParameters `json:"forProvider"`
}

// A MemberStatus represents the observed state of a Gitlab GroupMember.
...
// A Member is a managed resource that represents a Gitlab GroupMember
